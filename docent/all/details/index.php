...
<?php include '../../../includes/docent_header.php'; ?>
    <div class="container">
        ...
        if (isset($_GET["id"])) {
            ...
            $query = "SELECT * FROM producten_docenten WHERE bestelling_id = $bestellingID";
            $besteldx = "SELECT besteld AS besteld_x FROM bestellingen_docenten WHERE id = $bestellingID";
            $totalQuery = "SELECT totaalprijs AS total_prijs FROM bestellingen_docenten WHERE id = $bestellingID";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>" . $row["naam"] . "</td>";
                    echo "<td><a href=" . $row["link"] . "> Link naar product (klik hier)</a></td>";
                ...
                echo "<a href='javascript:javascript:history.go(-1)' class='btn btn-primary'>Terug naar bestelde bestellingen</a>";
            } else {
