    ...
    if ($emailResult->num_rows > 0) {
        ...
        if (mail($ontvanger, $onderwerp, $bericht, $headers)) {
            ...
            if ($result->num_rows > 0) {
                echo "<h2>Bestellingen gevonden voor e-mailadres: $email</h2>";
                ...
                echo "<p>Geen bestellingen gevonden voor e-mailadres: $email</p>";
            }
        ...
        <a class="btn btn-primary" href="../bestelling">Terug naar de e-mail zoekfunctie</a>
    </div>
</body>
</html>