    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($row['besteld'] == 0) {
                    echo "<td>
                        <a class='btn btn-primary' href='?markeer=" . $row['id'] . "' onclick='return confirm(\"Weet u zeker dat u deze bestelling wilt markeren als besteld?\")'>Besteld</a>
                        <a class='btn btn-danger' href='../bestelling/afkeur.php/?id=" . $row['id'] . "'>Afkeuren</a>
                            </td>";
                } else {
                    echo "<td>
                    <a class='btn btn-danger' href='?verwijder=" . $row['id'] . "' onclick='return confirm(\"Weet u zeker dat u deze bestelling wilt verwijderen?\")'>Verwijderen</a> <!-- Nieuwe kolom -->
                </td>";
                }
